...
import { EdgeModel } from "@/outter/fr-schema-antd-utils/src/components/GGeditor/common/interfaces"
...
const options = {
    draw(model: EdgeModel, group: G.Group) {
        ...
        if (
            startNode.getModel().y === endNode.getModel().y &&
            endNode.getModel().x < 0
        ) {
        ...
        if (
            endNode.getModel().x < 0 &&
            endNode.getModel().y > startNode.getModel().y
        ) {
        ...
        return group.addShape("path", {
            attrs: {
                path: [
                    ...
                    [
                        "L",
                        startX - sourceWidth - offset + radius,
                    ...
                    [
                        ...
                        0,
                        0,
                        startX - sourceWidth - offset,
                        startY + sourceHeight / 2 + radius
                    ],
